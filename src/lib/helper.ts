...
export const splitIntoByte = (bits: string) => {
  const bitArray = [];
...
export const shiftLeft128ByOne = (bits128: Uint8Array) => {
...
export const shiftLeft128ByTwo = (bits128: Uint8Array) => {
  for (let i = 0; i < 2; i++) {
...
export const shiftRight128ByOne = (bits128: Uint8Array) => {
...
export const shiftRight128ByTwo = (bits128: Uint8Array) => {
  for (let i = 0; i < 2; i++) {
...
export const expansionPermutation = (bit: string) => {
  const pbox = [
...
export const splitPlaintextTo128Bit = (plaintext: string) => {
