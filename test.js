...
const decryptFeistelV2 = (cipherTextA, cipherTextB, cipherTextC, cipherTextD, key) => {
  ...
  const originalPlaintextA = xor(cipherTextD, bitToBytes(splitIntoByte(reverseInnerFeistelResultB)));
  ...
  const originalPlaintextB = xor(cipherTextA, bitToBytes(splitIntoByte(reverseInnerFeistelResultC)));
  ...
  const originalPlaintextC = xor(cipherTextB, bitToBytes(splitIntoByte(reverseInnerFeistelResultD)));
  ...
  return [new Uint8Array(originalPlaintextA), new Uint8Array(originalPlaintextB), new Uint8Array(originalPlaintextC), new Uint8Array(originalPlaintextD)];
}
